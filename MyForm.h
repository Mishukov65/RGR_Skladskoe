...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(261, 0);
			...
			this->dataGridView1->Size = System::Drawing::Size(571, 384);
			...
			this->tabControl1->Size = System::Drawing::Size(836, 427);
			...
			this->tabPage1->Size = System::Drawing::Size(828, 398);
			...
			this->label15->Location = System::Drawing::Point(67, 55);
			...
			// monthCalendar1
			// 
			this->monthCalendar1->Location = System::Drawing::Point(32, 101);
			...
			this->tabPage2->Size = System::Drawing::Size(828, 398);
			...
			this->label9->Location = System::Drawing::Point(173, 261);
			...
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(189, 281);
			...
			this->label1->Location = System::Drawing::Point(173, 149);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(189, 169);
			...
			this->label13->Location = System::Drawing::Point(336, 261);
			...
			// numericUpDown5
			// 
			this->numericUpDown5->Location = System::Drawing::Point(355, 281);
			...
			this->label12->Location = System::Drawing::Point(259, 343);
			this->label12->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label12->Name = L"label12";
			this->label12->Size = System::Drawing::Size(293, 35);
			this->label12->TabIndex = 23;
			this->label12->Text = L"Выбирайте действие";
			// 
			// label11
			// 
			this->label11->AutoSize = true;
			this->label11->Location = System::Drawing::Point(476, 42);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(457, 62);
			...
			this->label10->Location = System::Drawing::Point(476, 260);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(457, 279);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(633, 273);
			...
			this->label8->Location = System::Drawing::Point(72, 279);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(633, 58);
			...
			this->label7->Location = System::Drawing::Point(336, 42);
			...
			this->label6->Location = System::Drawing::Point(173, 41);
			...
			// numericUpDown3
			// 
			this->numericUpDown3->Location = System::Drawing::Point(355, 62);
			...
			this->label5->Location = System::Drawing::Point(71, 64);
			...
			this->label4->Location = System::Drawing::Point(72, 172);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(633, 165);
			...
			this->label3->Location = System::Drawing::Point(488, 149);
			...
			this->label2->Location = System::Drawing::Point(351, 151);
			...
			// numericUpDown2
			// 
			this->numericUpDown2->Location = System::Drawing::Point(480, 169);
			...
			this->listBox1->Location = System::Drawing::Point(363, 172);
			...
			this->tabPage4->Size = System::Drawing::Size(828, 398);
			...
			this->tabControl2->Size = System::Drawing::Size(809, 380);
			...
			this->tabPage5->Size = System::Drawing::Size(801, 351);
			...
			this->tabPage6->Size = System::Drawing::Size(801, 351);
			...
			this->tabPage7->Size = System::Drawing::Size(801, 351);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(479, 27);
			...
			this->tabPage3->Size = System::Drawing::Size(828, 398);
			...
			// button11
			// 
			this->button11->Location = System::Drawing::Point(476, 271);
			...
			// button10
			// 
			this->button10->Location = System::Drawing::Point(57, 112);
			...
			// button7
			// 
			this->button7->Location = System::Drawing::Point(57, 271);
			...
			// button6
			// 
			this->button6->Location = System::Drawing::Point(57, 324);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(476, 324);
...
private: System::Void Button2_Click(System::Object^ sender, System::EventArgs^ e) {
	ofstream out, repM, repC, repP;//вывод информации в файл
	...
	string str = "";//временная переменная для записи в неё строчек из базы данных(из файла db.txt)
	string str4 = "*";//разделение дат
	string editName, editVal;
	bool trigger = false;
	bool notFound = true;// наличие товара в конкретную дату

	in.open("db.txt");// открытие базы данных дял чтения
	out.open("buffer.txt");// временная база данных 
	repM.open("ReportM.txt", std::ios::app);// опция дозаписи
	repC.open("ReportC.txt", std::ios::app);
	repC.open("ReportP.txt", std::ios::app);
				...
				if (trigger) {
					if (str.find(name) != std::string::npos) {
						...
						if (action == "+") {
							...
							repP << endl << "Внутренние ПОСТУПЛЕНИЕ + [" << msclr::interop::marshal_as<string>(this->monthCalendar1->TodayDate.ToString()).substr(0, 10) << "] " << name << " " << val << " шт.";//отчёты в текстовые файлы
							...
							repP << endl << "Внутренние ПОСТУПЛЕНИЕ * [" << msclr::interop::marshal_as<string>(this->monthCalendar1->TodayDate.ToString()).substr(0, 10) << "] " << name << " " << val << " шт.";
							repC << endl << "Внутренние ПОСТУПЛЕНИЕ * [" << msclr::interop::marshal_as<string>(this->monthCalendar1->TodayDate.ToString()).substr(0, 10) << "] " << name << " " << val << " шт.";
							...
							if ((newVal - val) < 0) {
								...
								out << editName << " " << to_string(newVal - val) << " +" << endl;
								repM << endl << "Внутренняя РЕАЛИЗАЦИЯ - [" << msclr::interop::marshal_as<string>(this->monthCalendar1->TodayDate.ToString()).substr(0, 10) << "] " << name << " " << val << " шт.";
	...
	repC.close();
	remove("db.txt");
	rename("buffer.txt", "db.txt");
}
private: System::Void Button3_Click(System::Object^ sender, System::EventArgs^ e) {
	ofstream out, repP, repC;//объявление потоков 
	string name = msclr::interop::marshal_as<string>(this->textBox1->Text->ToString());//конвертируется информация которую м достали из Textbox1
	...
	Good good(name, atoi(val.c_str()), Partner(contragent));//объявление объект класса товар и констуктор с параметрами, контрагент(класс)

	out.open("db.txt", std::ios::app);//std::ios::app возмонжсть дописывания в файл
	repP.open("ReportP.txt", std::ios::app);
	repC.open("ReportC.txt", std::ios::app);
	if (name != "" || val != "" || contragent != "") {
		out << endl << "* " << msclr::interop::marshal_as<string>(this->monthCalendar1->TodayDate.ToString()).substr(0,10) << endl << good.getName() << " " << good.getCount() << " +";// запись в бд на текущую дату о количстве товара и его наименование
		repP << endl << "От " << contragent << " ПОСТУПЛЕНИЕ [" << msclr::interop::marshal_as<string>(this->monthCalendar1->TodayDate.ToString()).substr(0, 10) << "] " << good.getName() << " " << good.getCount() << " шт.";//запись в отчёты
		repC << endl << contragent << " ПОСТУПЛЕНИЕ [" << msclr::interop::marshal_as<string>(this->monthCalendar1->TodayDate.ToString()).substr(0, 10) << "] " << good.getName() << " " << good.getCount() << " шт.";//отчёт по контрагентам
...
private: System::Void MonthCalendar1_DateSelected(System::Object^ sender, System::Windows::Forms::DateRangeEventArgs^ e) {
		...
		string str = "";//обявление выбранной строки
		string str2 = msclr::interop::marshal_as<string>(e->Start.ToShortDateString()->ToString());//получение текущей даты
		String^ str3 = gcnew String(str.c_str());// получение малого стринга для вывода в таблицу
		string str4 = "*";//отделение выбранной жаты от последующих
		...
		while (getline(in, str)) {//перебор всех строк для поиска текущей даты
			...
			if (trigger) {
				...
				while (str[i] != ' ') {// до проблема поиск наименования товара 
					insert[0] += str[i];//добавление  последующих символов(строим наименвоание товара посимовольно)
					i++;
				}
				while (str[i] != '+') {
					insert[1] += str[i];
...
private: System::Void TabControl2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		string str = "";
		this->richTextBox1->Text = gcnew String("");//очистка бокса дял дальнейшей записи
		in.open("ReportP.txt");//открытие файла с отчётами о пополнении 
...
private: System::Void TabControl1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	in.open("ReportP.txt");//поиск контрагента по плюсовым отчётам
	while (getline(in, str)) {
		if (str != "") {
			str += "\n";
	...
	string str1 = "";
	this->richTextBox2->Text = gcnew String("");
	in1.open("ReportM.txt");//поиск контрагента по минусовым отчётам
	while (getline(in1, str1)) {
		if (str != "") {
			str1 += "\n";
			this->richTextBox2->Text += gcnew String(str1.c_str());
...
private: System::Void Button4_Click(System::Object^ sender, System::EventArgs^ e) {//отпуск товара
	...
	Good good(name, val, Partner(contragent));

	in.open("db.txt");
	out.open("buffer.txt");
	repM.open("ReportM.txt", std::ios::app);
	repC.open("ReportC.txt", std::ios::app);
				...
				if (trigger) {
					if (str.find(name) != std::string::npos) {
						...
						if ((newVal - val) < 0) {
							...
							repM << endl << "Для " << contragent << " РЕАЛИЗАЦИЯ [" << msclr::interop::marshal_as<string>(this->monthCalendar1->TodayDate.ToString()).substr(0, 10) << "] " << name << " " << val << " шт.";
...
private: System::Void Button6_Click(System::Object^ sender, System::EventArgs^ e) {//загрузка всех отчётов в файл
	...
	ifstream repM, repP;
	string str;
	repM.open("ReportM.txt");
	repP.open("ReportP.txt");
	out.open("COMMON_REPORT.txt");

	out << "ПОСТУПЛЕНИЯ: " << endl;
	while (getline(repP, str)) {
		out << str << endl;
	}
	out << endl << "РЕАЛИЗАЦИЯ: " << endl;
	while (getline(repM, str)) {
...
private: System::Void Button7_Click(System::Object^ sender, System::EventArgs^ e) {
	ofstream out;
	out.open("ReportP.txt");
	out << "";
	out.close();
}
private: System::Void Button8_Click(System::Object^ sender, System::EventArgs^ e) {
	ofstream out;
	out.open("ReportM.txt");
	out << "";
	out.close();
}
